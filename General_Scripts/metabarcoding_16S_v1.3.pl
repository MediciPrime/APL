...
my $ref_db = "/data/reference/RDPClassifier_16S_trainsetNo16_rawtrainingdata/trainset16_022016.fa";
my $read1 = shift;
my $read2 = shift;
...
# 16S.520F	AYTGGGYDTAAAGNG
# 16S.802R	TACNVGGGTATCTAATCC
...
# map otus to original sequences
...
system "java -Xmx1g -jar /data/bin/rdp_classifier_2.12/dist/classifier.jar classify -c 0.80 -g 16srrna -h $project_name.hierarchy.txt -o $project_name.classify.txt $project_name.otus.good.fasta";
